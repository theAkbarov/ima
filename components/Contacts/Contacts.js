...
//                 <h4 className={ContactsScss.contact_subtitle}>Телефон</h4>
...
//               </li>
//               <li className={ContactsScss.contact_subitem}>
//                 <h4 className={ContactsScss.contact_subtitle}>Тех поддержка</h4>
//                 <p className={ContactsScss.contact_telnumber}>
//                   +998 (71) 232 50 05
//                 </p>
//               </li>
//               <li className={ContactsScss.contact_subitem}>
//                 <h4 className={ContactsScss.contact_subtitle}>Факс</h4>
//                 <p className={ContactsScss.contact_telnumber}>
//                   +998 (71) 232 50 51
//                 </p>
//               </li>
...
//               <h4 className={ContactsScss.contact_subtitle}>Адрес</h4>
//               <p className={ContactsScss.contact_addresstext}>
//                 100174, г. Ташкент, <br /> Алмазарский район, <br /> ул.
//                 Университетская, 7
//               </p>
//             </span>
//             <span className={ContactsScss.contact_job}>
//               <h4 className={ContactsScss.contact_jobtime}>Режим работы</h4>
...
//               <h4 className={ContactsScss.contact_subtitle}>E-mail</h4>
//               <Link href="info@imao.uz">
//                 <a className={ContactsScss.contact_emailaddres}>info@imao.uz</a>
//               </Link>
//             </span>
//             <span className={ContactsScss.contact_networkicons}>
//               <button className={ContactsScss.contact_networkicon_1}>
//                 <FaYoutube />
//               </button>
//               <button className={ContactsScss.contact_networkicon_2}>
//                 <FaTelegramPlane />
//               </button>
//               <button className={ContactsScss.contact_networkicon_3}>
//                 <FaFacebookF />
//               </button>
//               <button className={ContactsScss.contact_networkicon_4}>
//                 <FaInstagram />
//               </button>
//             </span>
//           </li>
